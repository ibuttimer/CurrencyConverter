...
rem See currency-conversion-service/README.MD#"MySQL connection string" for information
rem regarding the MySQL connection string
set MYSQL_CONVERSION_URL=//localhost:3306/currency_conversion?useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC
...
for %%E IN (
    MYSQL_CONVERSION_URL, CURRENCY_EXCHANGE_URL, TRACING_ENABLED
 ) do (
  echo %%E: !%%E!
)
